...
class CreditPaymentDetailsDb extends _CreditPaymentDetailsDb
  ...
  double get adjustment =>
      RealmObjectBase.get<double>(this, 'adjustment') as double;
  @override
  set adjustment(double value) =>
...
class RecurrenceDb extends _RecurrenceDb
  ...
  bool get autoCreateTransaction =>
      RealmObjectBase.get<bool>(this, 'autoCreateTransaction') as bool;
  @override
  set autoCreateTransaction(bool value) =>
      RealmObjectBase.set(this, 'autoCreateTransaction', value);

  @override
  TemplateTransactionDb? get templateTransaction =>
      RealmObjectBase.get<TemplateTransactionDb>(this, 'templateTransaction')
          as TemplateTransactionDb?;
  @override
  set templateTransaction(covariant TemplateTransactionDb? value) =>
...
class BalanceAtDateTimeDb extends _BalanceAtDateTimeDb
  ...
  static SchemaObject _initSchema() {
    ...
    return const SchemaObject(
        ObjectType.realmObject, BalanceAtDateTimeDb, 'BalanceAtDateTimeDb', [
      SchemaProperty('id', RealmPropertyType.objectid, primaryKey: true),
