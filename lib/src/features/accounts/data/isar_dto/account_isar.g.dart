...
const AccountIsarSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'creditDetailsIsar': PropertySchema(
      id: 1,
      name: r'creditDetailsIsar',
      type: IsarType.object,
      target: r'CreditDetailsIsar',
    ),
  ...
  embeddedSchemas: {r'CreditDetailsIsar': CreditDetailsIsarSchema},
...
int _accountIsarEstimateSize(
  ...
  var bytesCount = offsets.last;
  {
    ...
    if (value != null) {
      bytesCount += 3 +
          CreditDetailsIsarSchema.estimateSize(
              value, allOffsets[CreditDetailsIsar]!, allOffsets);
    }
  }
...
void _accountIsarSerialize(
  ...
  writer.writeObject<CreditDetailsIsar>(
    offsets[1],
    allOffsets,
    CreditDetailsIsarSchema.serialize,
...
AccountIsar _accountIsarDeserialize(
  ...
  object.creditDetailsIsar = reader.readObjectOrNull<CreditDetailsIsar>(
    offsets[1],
    CreditDetailsIsarSchema.deserialize,
    allOffsets,
  );
...
extension AccountIsarQueryFilter
  ...
  QueryBuilder<AccountIsar, AccountIsar, QAfterFilterCondition>
      creditDetailsIsarIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'creditDetailsIsar',
      ));
    });
  }

  QueryBuilder<AccountIsar, AccountIsar, QAfterFilterCondition>
      creditDetailsIsarIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountIsarQueryObject
    on QueryBuilder<AccountIsar, AccountIsar, QFilterCondition> {
  QueryBuilder<AccountIsar, AccountIsar, QAfterFilterCondition>
      creditDetailsIsar(FilterQuery<CreditDetailsIsar> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'creditDetailsIsar');
    });
  }
}
...
extension AccountIsarQueryProperty
  ...
  QueryBuilder<AccountIsar, CreditDetailsIsar?, QQueryOperations>
      creditDetailsIsarProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'creditDetailsIsar');
    });
  }
...
const CreditDetailsIsarSchema = Schema(
  name: r'CreditDetailsIsar',
  ...
  estimateSize: _creditDetailsIsarEstimateSize,
  serialize: _creditDetailsIsarSerialize,
  deserialize: _creditDetailsIsarDeserialize,
  deserializeProp: _creditDetailsIsarDeserializeProp,
);

int _creditDetailsIsarEstimateSize(
...
void _creditDetailsIsarSerialize(
  CreditDetailsIsar object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
CreditDetailsIsar _creditDetailsIsarDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _creditDetailsIsarDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension CreditDetailsIsarQueryObject
    on QueryBuilder<CreditDetailsIsar, CreditDetailsIsar, QFilterCondition> {}
