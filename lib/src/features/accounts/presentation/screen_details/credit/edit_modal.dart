      ...
      footer: ModalFooter(
        ...
        onSmallButtonTap: () {
          showConfirmModal(
            context: context,
            label:
                'Are you sure that you want to delete credit account "${widget.currentCreditAccount.name}"?'.hardcoded,
            subLabel: '1 more confirmation to delete this account'.hardcoded,
            onConfirm: () {
              showConfirmModal(
                context: context,
                label:
                    'Are you sure? All transactions (except payments to this account) will be deleted, too.'.hardcoded,
