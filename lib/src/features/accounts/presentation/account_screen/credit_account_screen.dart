...
class _CreditAccountScreenState extends State<CreditAccountScreen> {
  ...
  List<BaseCreditTransaction> txnsInBillingCycleBeforePreviousDueDate(Statement statement) {
        ...
        itemBuilder: (context, pageIndex) {
          ...
          return statement != null
              ? [
                  ...
                  ...buildTransactionTile(context, txnsInBillingCycleBeforePreviousDueDate(statement), statement),
                  _Header(
...
class _Transaction extends StatelessWidget {
  const _Transaction(
      {required this.statement, this.transaction, this.dateTime, this.isSelectedDay = false, this.fullPaymentAmount});
