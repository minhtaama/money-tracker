...
class AssetReportWidget extends ConsumerStatefulWidget {
  const AssetReportWidget({super.key, required this.dateTimes});

  final List<DateTime> dateTimes;

  @override
  ConsumerState<AssetReportWidget> createState() => _AssetReportWidgetState();
}

class _AssetReportWidgetState extends ConsumerState<AssetReportWidget> {
