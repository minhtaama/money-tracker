                            ...
                            return _CustomCalendarDialog(
                              ...
                              contentBuilder: ({required DateTime monthView, DateTime? selectedDay}) {
                                if (selectedDay != null) {
                                  ...
                                  // print(statement?.apr);
                                  // print(statement?.previousStatement.interest);
                                }
                                return AnimatedSize(
...
extension _Details on _DateTimeSelectorCreditState {
  Widget _dayBuilder(
    ...
    final foregroundColor = isDisabled != null && isDisabled
        ...
        : isSelected != null && isSelected
            ...
            : context.appTheme.backgroundNegative.withOpacity(_canAddTransaction(date) ? 1 : 0.33);
  ...
  bool _canAddTransaction(DateTime dateTime) {
    ...
    return !widget.creditAccount!.isBeforeLastCheckpoint(dateTime) &&
        !widget.creditAccount!.isBeforeStatementHasLastPayment(dateTime);
  }
