...
/// [ModifiedAnimatedCrossFade] is rebuilt with a different value for the
...
/// [ModifiedAnimatedCrossFade] widget cross-fades between the two forms of the logo
/// over three seconds.
///
/// ```dart
/// AnimatedCrossFade(
...
///  * [AnimatedSize], the lower-level widget which [ModifiedAnimatedCrossFade] uses to
///    automatically change size.
class ModifiedAnimatedCrossFade extends StatefulWidget {
  ...
  const ModifiedAnimatedCrossFade({
    super.key,
  ...
  ///
  /// By default, this uses [ModifiedAnimatedCrossFade.defaultLayoutBuilder], which uses
  ...
  /// constraints. This works well when the [ModifiedAnimatedCrossFade] is in a position
  ...
  /// [ModifiedAnimatedCrossFade] is being forced to a particular size, then it can
  ...
  /// The default layout algorithm used by [ModifiedAnimatedCrossFade].
  ///
  ...
  @override
  State<ModifiedAnimatedCrossFade> createState() => _ModifiedAnimatedCrossFadeState();
...
class _ModifiedAnimatedCrossFadeState extends State<ModifiedAnimatedCrossFade> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ModifiedAnimatedCrossFade oldWidget) {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(DiagnosticsProperty<AlignmentGeometry>('alignment', widget.alignment, defaultValue: Alignment.topCenter));
  }
}
