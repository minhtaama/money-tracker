...
class AppColors {
  ...
  static final _theme1 = <ThemeType, AppThemeData>{
    ...
    ThemeType.dark: AppThemeData(
      ...
      background0: const Color(0xff202426),
      background1: const Color(0xFF14161A),
      background2: const Color(0xFF1A1C21),
  ...
  static final _theme2 = <ThemeType, AppThemeData>{
    ...
    ThemeType.dark: AppThemeData(
      ...
      background0: const Color(0xff202426),
      background1: const Color(0xFF181A1F),
      background2: const Color(0xFF1A1C21),
      onPrimary: const Color(0xFF212529),
      onSecondary: const Color(0xFF212529),
      onAccent: const Color(0xFF212529),
  ...
  static final _theme3 = <ThemeType, AppThemeData>{
    ThemeType.light: AppThemeData(
      ...
      background0: const Color(0xfffcfcfa),
      background1: const Color(0xffecedeb),
    ...
    ThemeType.dark: AppThemeData(
      ...
      background0: const Color(0xFF1C1F1C),
      background1: const Color(0xFF131413),
      background2: const Color(0xFF0E0F0E),
      onPrimary: const Color(0xFF212529),
      onSecondary: const Color(0xFF212529),
      onAccent: const Color(0xFF212529),
      onBackground: AppColors.white,
